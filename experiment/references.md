...
1. **Thomas H. Cormen, Charles E. Leiserson, Ronald L. Rivest, and Clifford Stein**,  
   *Introduction to Algorithms*, 3rd Edition, MIT Press, 2009.  
   (Chapter 33: Computational Geometry - Closest Pair of Points)

2. **Jon Kleinberg and Eva Tardos**,  
   *Algorithm Design*, 1st Edition, Pearson, 2005.  
   (Chapter 5: Divide and Conquer - Finding the Closest Pair of Points)
